               ...
               background-image: -moz-linear-gradient(top, rgba(0,0,0,0.81) 0%, rgba(0,0,0,0) 100%), url(bg_textured.jpg); /* FF3.6+ */
               background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(0,0,0,0.81)), color-stop(100%,rgba(0,0,0,0))), url(bg_textured.jpg); /* Chrome,Safari4+ */
               background-image: -webkit-linear-gradient(top, rgba(0,0,0,0.81) 0%,rgba(0,0,0,0) 100%), url(bg_textured.jpg); /* Chrome10+,Safari5.1+ */
               background-image: -o-linear-gradient(top, rgba(0,0,0,0.81) 0%,rgba(0,0,0,0) 100%), url(bg_textured.jpg); /* Opera11.10+ */
               background-image: -ms-linear-gradient(top, rgba(0,0,0,0.81) 0%,rgba(0,0,0,0) 100%), url(bg_textured.jpg); /* IE10+ */
               background-image: linear-gradient(top, rgba(0,0,0,0.81) 0%,rgba(0,0,0,0) 100%), url(bg_textured.jpg); /* W3C */ }
